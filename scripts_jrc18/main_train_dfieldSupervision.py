...
from data import GenerateDataDfield
...
#dfield_list = [ FILL THIS IN ]

train_list = img_list[1] # train_list = img_list[:-10]
...
for epoch in range(total_epoch):
    ...
    train_data = GenerateDataDfield(train_list, dfield_list, crop_sz)
    ...
    if epoch % save_iter == save_iter-1:
        ...
        eval_data = GenerateDataDfield(eval_list, dfield_list, crop_sz)
